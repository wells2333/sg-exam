...
import com.github.tangyi.exam.service.subject.media.SubjectMediaService;
...
@Tag(name = "题目内容（图片、视频）")
@RestController
@RequestMapping("/v1/subjectMedia")
public class SubjectMediaController extends BaseController {

	private final SubjectMediaService subjectUploadVideoService;
	...
	public R<Attachment> uploadVideo(
		...
		return R.success(subjectUploadVideoService.uploadVideo(file));
	}
