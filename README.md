...
<p>
  <img alt="Version" src="https://img.shields.io/badge/version-v5.0.0-blue.svg?cacheSeconds=2592000" />
...
> 硕果云，基于Spring Boot搭建的新一代教学管理平台，提供权限管理、考试、问卷、练习等功能
>
> 题型支持单选题、多选题、判断题、简答题、视频、语音等
>
> 支持PC、H5、微信小程序
