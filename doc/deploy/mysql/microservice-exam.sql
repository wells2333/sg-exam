...
INSERT INTO `course` VALUES ('573843243792470016', '计算机基础', '信息学院', '软件工程', '', '', 'admin', '2019-05-03 12:08:10', 'admin', '2019-05-03 12:08:10', '0', 'EXAM');
...
-- ----------------------------
INSERT INTO `examination` VALUES ('571450640874737664', '四川省2016年普通高考文科综合能力测试-语文部分', '0', '注意事项:\n1.本试卷分第工卷(选择题)和第II卷(非选择题)两部分。答卷前，考生务必将白己的姓名、准考证号填写在答题卡上。\n2.回答第Ⅰ卷时，选出每小题答案后，用铅笔把答题卡上对应题目的答案标号涂黑。如需改动，用橡皮擦干净后，再选涂其它答案标号。写在本试卷上无效。\n3.回答第Ⅱ卷时，将答案写在答题卡上。写在本试卷上无效。\n4.考试结束后，将本试卷和答题卡一并交回。', '2019-05-08 15:40', '2019-05-08 23:40', '', '48', '12', '0', '', NULL, '信息学院', '软件工程', '571449673634680832', '四川省2016年普通高考-文科综合能力测试', 'admin', '2019-04-26 21:40:49', 'admin', '2019-05-08 21:12:21', '0', 'EXAM');
INSERT INTO `examination` VALUES ('571460951203778560', '四川省2016年普通高考文科综合能力测试-地理部分', '0', '本卷共35个小题，每小题4分，共140分。在每小题给出的四个选项中，只有一项是符合题目要求的。', '2019-05-07 15:40', '2019-05-07 23:40', '', '200', '0', '0', '', NULL, '信息学院', '软件工程', '571449673634680832', '四川省2016年普通高考文科综合能力测试-地理部分', 'admin', '2019-04-26 22:21:47', 'admin', '2019-04-26 22:21:47', '1', 'EXAM');
INSERT INTO `examination` VALUES ('573841891515305984', '全国计算机统考练习题10道', '2', '练习', '2019-05-08 15:40', '2019-05-08 23:40', '', '40', '10', '0', '', NULL, '测试学院', '软件工程', '573843243792470016', '全国计算机统考练习题10道', 'admin', '2019-05-03 12:02:48', 'admin', '2019-05-08 21:12:10', '0', 'EXAM');
...
INSERT INTO `subject` VALUES ('573843792789114880', '573841891515305984', 1, '自计算机问世至今已经经历了四个时代，划分时代的主要依据是计算机的_', '0', '', '规模', '功能', '性能', '构成元件', '', '', 'D', 4, '', 2, 'admin', '2019-05-03 12:10:21', 'admin', '2019-05-03 12:10:21', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843833855545344', '573841891515305984', 2, '第一台计算机是在1946年在美国诞生，该机的英文缩写是_', '0', '', 'ENIAC', 'EDVAC', 'EDVAE', 'MARK', '', '', 'A', 4, '', 2, 'admin', '2019-05-03 12:10:31', 'admin', '2019-05-03 12:10:31', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843857750495232', '573841891515305984', 3, '当前的计算机一般被认为是第四代计算机，它所采用的逻辑元件是_', '0', '', '集成电路', '晶体管', '大规模集成电路', '电子管', '', '', 'C', 4, '', 2, 'admin', '2019-05-03 12:10:37', 'admin', '2019-05-03 12:10:37', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843879313412096', '573841891515305984', 4, '当前计算机的应用最广泛的领域是_', '0', '', '辅助设计', '科学计算', '数据处理', '过程控制', '', '', 'C', 4, '', 2, 'admin', '2019-05-03 12:10:42', 'admin', '2019-05-03 12:10:42', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843899269910528', '573841891515305984', 5, '早期的计算机体积大、耗电多、速度慢，其主要原因是制约于_', '0', '', '元材料', '工艺水平', '设计水平', '元器件', '', '', 'D', 4, '', 2, 'admin', '2019-05-03 12:10:47', 'admin', '2019-05-03 12:10:47', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843926826487808', '573841891515305984', 6, '现代计算机之所以能够自动、连续地进行数据处理，主要是因为_', '0', '', '采用了开关电路', '采用了半导体器件', '采用了二进制', '具有存储程序的功能', '', '', 'D', 4, '', 2, 'admin', '2019-05-03 12:10:53', 'admin', '2019-05-03 12:10:53', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843944526450688', '573841891515305984', 7, '电子计算机按规模和处理能力划分，可以分为_', '0', '', '数字电子计算机和模拟电子计算机', '通用计算机和专用计算机', '巨型计算机、中小型计算机和微型计算机', '科学与过程计算计算机、工业控制计算机和数据计算机', '', '', 'C', 4, '', 2, 'admin', '2019-05-03 12:10:57', 'admin', '2019-05-03 12:10:57', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843961102340096', '573841891515305984', 8, '将计算机分为通用计算机、专用计算机两类的分类标准是_', '0', '', '计算机处理数据的方式', '计算机使用范围', '机器的规模', '计算机的功能和处理能力', '', '', 'B', 4, '', 2, 'admin', '2019-05-03 12:11:01', 'admin', '2019-05-03 12:11:01', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843978617753600', '573841891515305984', 9, '既可以接收、处理和输出模拟量，也可以接收、处理和输出数字量的计算机是_', '0', '', '电子数字计算机', '电子模拟计算机', '数模混合计算机', '专用计算机', '', '', 'C', 4, '', 2, 'admin', '2019-05-03 12:11:06', 'admin', '2019-05-03 12:11:06', '0', 'EXAM');
INSERT INTO `subject` VALUES ('573843994983927808', '573841891515305984', 10, '至今日，计算机仍采用存储程序原理，原理的提出者是_', '0', '', '莫尔', '比尔·盖次', '冯·诺依曼', '科得', '', '', 'C', 4, '', 2, 'admin', '2019-05-03 12:11:09', 'admin', '2019-05-03 12:11:09', '0', 'EXAM');
...
INSERT INTO `subject_bank` VALUES ('573839142304223232', '573838899969921024', 1, '自计算机问世至今已经经历了四个时代，划分时代的主要依据是计算机的_', '0', '', '规模', '功能', '性能', '构成元件', '', '', 'D', 4, '', '2', 'admin', '2019-05-03 11:51:52', 'admin', '2019-05-03 12:01:13', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573839858523574272', '573838899969921024', 2, '第一台计算机是在1946年在美国诞生，该机的英文缩写是_', '0', '', 'ENIAC', 'EDVAC', 'EDVAE', 'MARK', '', '', 'A', 4, '', '2', 'admin', '2019-05-03 11:54:43', 'admin', '2019-05-03 11:54:43', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573840018745987072', '573838899969921024', 3, '当前的计算机一般被认为是第四代计算机，它所采用的逻辑元件是_', '0', '', '集成电路', '晶体管', '大规模集成电路', '电子管', '', '', 'C', 4, '', '2', 'admin', '2019-05-03 11:55:21', 'admin', '2019-05-03 11:55:21', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573840173176066048', '573838899969921024', 4, '当前计算机的应用最广泛的领域是_', '0', '', '辅助设计', '科学计算', '数据处理', '过程控制', '', '', 'C', 4, '', '2', 'admin', '2019-05-03 11:55:58', 'admin', '2019-05-03 11:55:58', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573840411693551616', '573838899969921024', 5, '早期的计算机体积大、耗电多、速度慢，其主要原因是制约于_', '0', '', '元材料', '工艺水平', '设计水平', '元器件', '', '', 'D', 4, '', '2', 'admin', '2019-05-03 11:56:55', 'admin', '2019-05-03 11:56:55', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573840623543652352', '573838899969921024', 6, '现代计算机之所以能够自动、连续地进行数据处理，主要是因为_', '0', '', '采用了开关电路', '采用了半导体器件', '采用了二进制', '具有存储程序的功能', '', '', 'D', 4, '', '2', 'admin', '2019-05-03 11:57:46', 'admin', '2019-05-03 11:57:46', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573840833552453632', '573838899969921024', 7, '电子计算机按规模和处理能力划分，可以分为_', '0', '', '数字电子计算机和模拟电子计算机', '通用计算机和专用计算机', '巨型计算机、中小型计算机和微型计算机', '科学与过程计算计算机、工业控制计算机和数据计算机', '', '', 'C', 4, '', '2', 'admin', '2019-05-03 11:58:36', 'admin', '2019-05-03 11:58:36', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573841001802764288', '573838899969921024', 8, '将计算机分为通用计算机、专用计算机两类的分类标准是_', '0', '', '计算机处理数据的方式', '计算机使用范围', '机器的规模', '计算机的功能和处理能力', '', '', 'B', 4, '', '2', 'admin', '2019-05-03 11:59:16', 'admin', '2019-05-03 11:59:16', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573841215032791040', '573838899969921024', 9, '既可以接收、处理和输出模拟量，也可以接收、处理和输出数字量的计算机是_', '0', '', '电子数字计算机', '电子模拟计算机', '数模混合计算机', '专用计算机', '', '', 'C', 4, '', '2', 'admin', '2019-05-03 12:00:07', 'admin', '2019-05-03 12:00:07', '0', 'EXAM');
INSERT INTO `subject_bank` VALUES ('573841445803397120', '573838899969921024', 10, '至今日，计算机仍采用存储程序原理，原理的提出者是_', '0', '', '莫尔', '比尔·盖次', '冯·诺依曼', '科得', '', '', 'C', 4, '', '2', 'admin', '2019-05-03 12:01:02', 'admin', '2019-05-03 12:01:02', '0', 'EXAM');
...
INSERT INTO `subject_category` VALUES ('573838899969921024', '计算机基础', NULL, '571449735345475584', '4', 'admin', '2019-05-03 11:50:55', 'admin', '2019-05-03 11:50:55', '0', 'EXAM');
