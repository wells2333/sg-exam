    ...
    <view class="subject-box" v-if="subject !== undefined">
      <view class="subject-content bg-white">
        ...
        <view>
          ...
          <view class="answer-text" v-if="showAnswerAndAnalysis && subject.answer !== undefined && subject.answer !== null && subject.answer !== ''">
            <text class="answer-text-title">答案：</text>
            <wxparse class="answer-text-value" :html="subject.answer.answer" key={Math.random()} />
          </view>
          <view class="answer-text answer-text-analysis" v-if="showAnswerAndAnalysis && subject.analysis !== undefined && subject.analysis !== null && subject.analysis !== ''">
            <view>
