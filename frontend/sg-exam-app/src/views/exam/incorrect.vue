<template>
  <div class="app-container">
    <el-card>
        ...
        <transition name="fade-transform" mode="out-in">
          <el-col :span="20" :offset="2" v-show="!examRecordLoading">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <label class="el-form-item__label">正确题数: </label><el-tag type="success" effect="dark">{{ examRecordDetail.correctNumber }}</el-tag>
              </el-col>
              <el-col :span="8">
                <label class="el-form-item__label">错误题数: </label><el-tag type="danger" effect="dark">{{ examRecordDetail.inCorrectNumber }}</el-tag>
              </el-col>
            </el-row>
          </el-col>
        </transition>
      ...
      <el-row>
        <el-col :span="20" :offset="2">
          <transition name="fade-transform" mode="out-in" v-for="(tempIncorrectAnswer) in list" :key="tempIncorrectAnswer.id">
