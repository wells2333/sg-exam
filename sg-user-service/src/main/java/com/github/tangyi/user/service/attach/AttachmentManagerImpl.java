...
public class AttachmentManagerImpl implements AttachmentManager {
    ...
    public AttachmentManagerImpl(AttachmentService attachmentService, AttachGroupService groupService,
                                 QiNiuAttachmentStorage qiNiuStorage,
                                 MinioAttachmentStorage minioAttachmentStorage,
    ...
    public Attachment prepareUploadChunks(AttachGroup group, Attachment attachment) {
        ...
        log.info("Prepare upload chunks finished, hash: {}, id: {}, update: {}, chunkDeleteRes: {}", hash, prepare.getId(), update, chunkDeleteRes);
        return prepare;
    }
